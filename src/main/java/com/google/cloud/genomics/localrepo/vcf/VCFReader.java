...
public class VCFReader implements AutoCloseable {
  ...
  public interface Callback<X> {
     ...
     */
    X readVcf(MetaInformation metaInformation, VCFHeader header, FluentIterable<VCFRecord> records)
        throws Exception;
  }
  ...
  private final Function<String, VCFRecord>
      PARSE_RECORD =
  ...
  public VCFRecord parseRecord(String line) {
    try {
      String
          fields[] = line.split("\t"),
          chrom = fields[0],
  ...
  public VCFReader(BufferedReader in) {
    this.in = in;
  }
